...
# MySQL data source. Use this variable to narrow down the scope of alerts. e.g. for sending alerts for a specific cluster, mysql_data_source = "db_cluster=labscluster", Leave blank to set scope to include all clusters.
mysql_data_source = ""
