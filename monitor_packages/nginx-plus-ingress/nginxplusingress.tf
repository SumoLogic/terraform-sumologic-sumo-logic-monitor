# Sumo Logic Nginx Plus Ingress Metric Monitor
module "DroppedConnections" {
  source                    = "SumoLogic/sumo-logic-monitor/sumologic"
  #version                  = "{revision}"
  monitor_name                = "Nginx Plus Ingress - Dropped Connections"
...
# Sumo Logic Nginx Plus Ingress Logs Monitor
module "AccessFromHighlyMaliciousSource" {
  source                    = "SumoLogic/sumo-logic-monitor/sumologic"
  #version                  = "{revision}"
  monitor_name                = "Nginx Plus Ingress - Access from Highly Malicious Sources"
...
module "CriticalErrorMessage" {
  source                    = "SumoLogic/sumo-logic-monitor/sumologic"
  #version                  = "{revision}"
  monitor_name                = "Nginx Plus Ingress - Critical Error Messages"
...
module "HighClientError" {
  source                    = "SumoLogic/sumo-logic-monitor/sumologic"
  #version                  = "{revision}"
  monitor_name                = "Nginx Plus Ingress - High Client (HTTP 4xx) Error Rate"
...
module "HighServerError" {
  source                    = "SumoLogic/sumo-logic-monitor/sumologic"
  #version                  = "{revision}"
  monitor_name                = "Nginx Plus Ingress - High Server (HTTP 5xx) Error Rate"
